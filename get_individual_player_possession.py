...
from helper.get_smallest_angle import *
    ...
    if inplace:
        ...
        if debug:
            return {
                ...
                "valid_gains_start_idxs": valid_gains_start_idxs,
                "ball_losses_idxs": ball_losses_idxs,
                "initial_possession": initial_possession,
            }
        return possession
...
def get_ball_losses_and_updated_gain_idxs(
    ...
    valid_idxs = (ball_losses_idxs != MISSING_INT) & valid_gains
    valid_gains_start_idxs = possession_start_idxs[valid_idxs]
    ball_losses_idxs = ball_losses_idxs[valid_idxs]
